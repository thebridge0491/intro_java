...
prep_swig build/classic_c_wrap.c : src/main/java/$(namespace_path)/Classic_c.i ## prepare Swig files
	-mkdir -p build/classes
	-swig -v -java -package $(groupid).$(parent).$(pkg) -I$(ffi_incdir) -outdir src/main/java/$(namespace_path)/ -o build/classic_c_wrap.c src/main/java/$(namespace_path)/Classic_c.i
