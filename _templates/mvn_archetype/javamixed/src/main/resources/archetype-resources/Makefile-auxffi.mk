...
prep_swig build/classic_c_wrap.c : src/main/java/${symbol_dollar}(namespace_path)/Classic_c.i ${symbol_pound}${symbol_pound} prepare Swig files
	-mkdir -p build/classes
	-swig -v -java -package ${symbol_dollar}(groupid).${symbol_dollar}(parent).${symbol_dollar}(pkg) -I${symbol_dollar}(ffi_incdir) -outdir src/main/java/${symbol_dollar}(namespace_path)/ -o build/classic_c_wrap.c src/main/java/${symbol_dollar}(namespace_path)/Classic_c.i
