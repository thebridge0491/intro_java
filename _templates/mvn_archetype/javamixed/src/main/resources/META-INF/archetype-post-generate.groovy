...
if (Files.exists(Paths.get("${dirX}/build/choices/build_tool")) && (buildTool in ['gradle', 'maven', 'ant', 'sbt', 'rake', 'make'])) {
...
if (Files.exists(Paths.get("${dirX}/build/choices/testfrwk")) && (testFrwk in ['junit', 'testng'])) {
