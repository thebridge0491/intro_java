...
(defn save-template
  ...
  (let [save-dir (format "%s/Templates/lein_new/org.sandbox.javamixed" to-dir)]
...
(defproject org.sandbox.javamixed/lein-template (get sys-props "templateVersion" "0.1.0")
  :description ~(get sys-props "description" "A Leiningen template for mixed Java project (choices skeleton: skeleton_java).")
  :url ~(format "http://%s/%s/javamixed" (get sys-props "repoHost" "bitbucket.org")
...
;; LEIN_JVM_OPTS -- example: LEIN_JVM_OPTS="-Dskeleton=skeleton_java -Dexecutable=yes"
